...
<body class="goto-here">
                ...
                <div class="col-lg-12 d-block">
                    <div class="row d-flex">
                        <div class="col-md pr-4 d-flex topper align-items-center">
                            ...
                            <span class="text">+52 xxxx xxxx xx</span>
                        </div>
                        <div class="col-md pr-4 d-flex topper align-items-center">
                            <div class="icon mr-2 d-flex justify-content-center align-items-center"><span
                        ...
                        <div class="col-md-5 pr-4 d-flex topper align-items-center text-lg-right">
                            <span class="text">Numero &amp; Email de contacto</span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
        <div class="container">
            <i><img style="height:100px; width:100px;" src="{{asset('frontend/images/circlelogosmall.png')}}" alt=""></i>
        <a class="navbar-brand" href="{{route('home')}}">Salsas Don Diego</a>
            ...
            <div class="collapse navbar-collapse" id="ftco-nav">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item"><a href="{{route('recetas')}}" class="nav-link">Recetas</a></li>
    ...
    <footer class="ftco-footer ftco-section">
        <div class="container">
            ...
            <div class="row mb-5">
                ...
                <div class="col-md">
                    <div class="ftco-footer-widget mb-4">
                        <h2 class="ftco-heading-2">Cualquier duda.</h2>
                        <div class="block-23 mb-3">
                            <ul>
                                <li><a href="#"><span class="icon icon-phone"></span><span class="text">+52 xxx xxxx
                                            xxx</span></a></li>
                                <li><a href="#"><span class="icon icon-envelope"></span><span
                                            class="text">youremail@email.com</span></a></li>
                                <li><span class="icon icon-map-marker"></span><span class="text">Tlacotalpan, Veracruz, Mexico</span></li>
                            </ul>
                        </div>
                    </div>
                </div>
